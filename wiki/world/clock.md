...
Between sessions, world time runs at real-time speed (one real minute = one world minute), adjusted by freezes and fast-forwards — so a real Earth day away is just under two local days. In session, time is narrative — it follows the story (see CLAUDE.md, "Time"). This page is updated at every session open and close, and by `/freeze`, `/unfreeze`, and `/ff`.
